...
<body>
    <div id="container">
        ...
        <div id="board" class="board">
            <!-- Board content will be dynamically generated by JavaScript -->
        </div>
        ...
        <div id="average-guesses" class="average-guesses">
            Average Guesses: <span id="average-guesses-value">0</span>
        </div>
    </div>
